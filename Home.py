...
homePage, insertPage, viewPage, answerKeyPage, downloadPage, disclaimerPage = st.tabs(["📢 Intro", "✍ Add Question to Test", "📝 View Test", "📚 View Answer Key", "📥 Download Files", "❗ Disclaimer"])
...
with disclaimerPage:
    ...
    **Responsible Use Guidelines:**
    ...
    Do not use this tool to generate harmful, discriminatory, or offensive content. To ensure the tool is used responsibly and ethically, please review, verify, and edit the AI generated content to ensure that it is accurate and aligns with the intended purpose.
